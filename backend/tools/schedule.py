...
async def schedule_message(chat_id: Union[int, str], message: str, minutes_from_now: int) -> str:
    try:
        if minutes_from_now < 1: return "Error: minutes_from_now must be at least 1"
        if minutes_from_now > 525600: return "Error: minutes_from_now cannot exceed 525600 (1 year)"
