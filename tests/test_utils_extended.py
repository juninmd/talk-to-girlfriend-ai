...
from backend.utils import json_serializer, log_and_format_error, ErrorCategory, format_entity, get_sender_name
...
def test_log_and_format_error_category_prefix():
    msg = log_and_format_error("func", Exception("e"), prefix=ErrorCategory.CHAT)
